...
import com.apex.cards.dto.ErrorResponseDto;
import com.apex.cards.dto.ResponseDto;
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside ApexBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<CardsDto> fetchCardDetails( @RequestHeader("apexbank-correlation-id")
                                                      ...
                                                      @RequestParam
                                                               @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                               String mobileNumber) {
        logger.debug("apexBank-fetchCardsDetails start : ");
        CardsDto cardsDto = iCardsService.fetchCard(mobileNumber);
        logger.debug("apexBank-fetchCardsDetails end : ");
